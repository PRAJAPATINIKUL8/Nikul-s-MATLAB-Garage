###########################################################################
## Makefile generated for component 'TJA_Model'. 
## 
## Makefile     : TJA_Model.mk
## Generated on : Tue Oct 28 10:59:59 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/TJA_Model
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/TJA_Model
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/TJA_Model_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=TJA_Model -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/TJA_Model_ert_rtw/TJA_Model.c $(START_DIR)/TJA_Model_ert_rtw/TJA_Model_data.c

MAIN_SRC = $(START_DIR)/TJA_Model_ert_rtw/ert_main.c
...
OBJS = TJA_Model.o TJA_Model_data.o
...
%.o : $(START_DIR)/TJA_Model_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/TJA_Model_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/TJA_Model_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/TJA_Model_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/TJA_Model_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
TJA_Model.o : $(START_DIR)/TJA_Model_ert_rtw/TJA_Model.c
	$(CC) $(CFLAGS) -o "$@" "$<"


TJA_Model_data.o : $(START_DIR)/TJA_Model_ert_rtw/TJA_Model_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/TJA_Model_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
