###########################################################################
## Makefile generated for component 'Displayunit'. 
## 
## Makefile     : Displayunit.mk
## Generated on : Tue Oct 28 10:58:06 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Displayunit
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Displayunit
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Displayunit_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Displayunit -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/Displayunit_ert_rtw/Displayunit.c $(START_DIR)/Displayunit_ert_rtw/Displayunit_data.c

MAIN_SRC = $(START_DIR)/Displayunit_ert_rtw/ert_main.c
...
OBJS = Displayunit.o Displayunit_data.o
...
%.o : $(START_DIR)/Displayunit_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Displayunit_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Displayunit_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Displayunit_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Displayunit_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Displayunit.o : $(START_DIR)/Displayunit_ert_rtw/Displayunit.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Displayunit_data.o : $(START_DIR)/Displayunit_ert_rtw/Displayunit_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Displayunit_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
